...
We provide a sample configuration file in Listing \ref{lst:configuration file}. The file is in JSON format, and the file is used to initialize the blockchain system at the beginning.

\begin{lstlisting}[caption={Configuration File}, label={lst:configuration file}]
{
    "nodes": [
        {
            "id": "6f71279b",
